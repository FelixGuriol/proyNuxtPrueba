    ...
    return new Vuex.Store({
        ...
        mutations: {
            setPosts(state,posts){
                state.loadedProducts=posts
            },
            addPost(state,post){
                state.loadedProducts.push(post)
            },
            editPost(state,editedPost){
                const postIndex = state.loadedProducts.findIndex(
                    post => post.id === editedPost.id
                );
                state.loadedProducts[postIndex] = editedPost;
            },
        ...
        actions: {
            ...
            addPost(vuexContext,post){
                ...
                return this.$axios
                    .$post('/products.json?auth='+vuexContext.state.token,createdPost)//mandar los datos firebase junto con el token
                    .then(data => {
            ...
            editPost(vuexContext,editedPost){
                return this.$axios.$put('/products/'+
